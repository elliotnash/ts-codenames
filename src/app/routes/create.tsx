...
export const Route = createFileRoute('/create')({
  ...
  loader: () => getBuckets(),
  head: () => ({ meta: [{ title: 'Create a room — Codenames' }] }),
      ...
      <main className="container mx-auto p-4 min-h-screen flex flex-col items-center justify-center">
        ...
        >
          <PageHeading
            ...
            title="Create a room"
            description="A room is a shareable board with its own code — anyone with the link can play."
          />
          ...
          <m.div variants={riseItem} className="space-y-8">
            <Separator />
